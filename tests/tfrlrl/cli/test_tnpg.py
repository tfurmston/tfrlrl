"""Tests for the truncated natural policy gradient CLI."""

import pytest
from hypothesis import given, settings
from hypothesis import strategies as st

from tfrlrl.cli.tnpg import main, parse_args
...
class TestMain:
    ...
    @given(
        ...
        alpha=st.floats(min_value=0.0000001, max_value=0.000001),
    )
    ...
    def test_main_with_different_parameters(
        ...
        Args:
            ...
            alpha: The base learning rate for the SGD optimizer used to apply the natural policy gradient.
    ...
    def test_main_with_n_iters_cg_and_n_samples_fim(self):
        """Test main function with --n-iters-cg and --n-samples-fim set."""
        args = [
            '--env-id',
            'FrozenLake-v1',
            '--policy-class',
